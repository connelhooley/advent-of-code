...
module Instructions =
    ...
    let perform (instructions:Instructions) : Results =
        
        let rec loop (robots, outputBins, result) instructions =
            ...
            if instructions |> List.isEmpty then
                ...
                let updatedState = 
                    instruction
                    |> Instruction.perform (robots, outputBins, result)
        ...
        loop (Destination.create, Destination.create, list.Empty) instructions